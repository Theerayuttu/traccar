    ...
    public Response send(Command entity, @QueryParam("groupId") long groupId) throws Exception {
        ...
        if (groupId > 0) {
            ...
            if (!queuedCommands.isEmpty()) {
                actionLogger.command(request, getUserId(), groupId,
                        entity.getDeviceId(), entity.getType(), entity.getString("data"), "QUEUE"); //add
        ...
        actionLogger.command(request, getUserId(), groupId,
                entity.getDeviceId(), entity.getType(), entity.getString("data"), "OK"); // add
